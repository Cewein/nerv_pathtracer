...
int main()
{
	...
	nerv::object scene(vertices,indices, new nerv::material(new nerv::texture("resources/evening_road_01.jpg"), new nerv::shader("shader/raytraced.frag.glsl", "shader/static.vert.glsl")));
